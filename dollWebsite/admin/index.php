			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="card dashboard-box">
						<a href="category.php">
							<div class="card-heading pt-3">
								<h1 class="text-center"><i class="fal fa-folder-plus text-large"></i> </h1>
							</div>
							<div class="card-body">
				...
				<div class="col-md-3 mt-3">
					<div class="card dashboard-box">
						<a href="category.php">
							<div class="card-heading pt-3">
								<h1 class="text-center"><i class="fal fa-clipboard-list-check text-large"></i> </h1>
							</div>
							<div class="card-body">
								<h6 class="text-center">افزودن دسته بندی</h6>
					</div>
						</a>
				...
				<div class="offset-3 col-md-9 mt-5">
					<i class="fal fa-quote-right text-large"></i>
					<p class="text-center">راه حل صحیح موفقیت این است که اشتیاق شما به پیروزی بیشتر از ترس شما از شکست باشد</p>
					<i class="fal fa-quote-left text-large float-left"></i>
				</div>
